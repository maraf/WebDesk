 ...
 * @author Mara
 */
public class FileSelectWindow extends DialogWindow {
    ...
    public FileSelectWindow(String filePath, ExplorerItemSelected listener) {
        ...
        btnSelect = new Button(Constants.webdesk().select(), new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                if (currentItem != null && FileSystemService.getItemType(currentItem).equals(ItemType.FILE)) {
